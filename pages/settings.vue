    ...
    <Card style="width: 25em" class="m-auto">
        ...
        <template #content>
            <div class="flex flex-col gap-8">
                <FloatLabel>
                    <InputText id="endpoint" v-model="s3Settings.endpoint" class="w-full" />
                ...
                <FloatLabel>
                    <InputText id="accKeyId" v-model="s3Settings.accKeyId" class="w-full" />
                    <label for="accKeyId">Access Key ID</label>
                </FloatLabel>
                <FloatLabel>
                    <InputText id="secretAccKey" v-model="s3Settings.secretAccKey" class="w-full" />
...
const settings = onMounted(() => {
    s3Settings.value = Object.assign({}, DEFAULT_SETTINGS, JSON.parse(localStorage.getItem("settings") || "{}"));
});
const save = () => {
