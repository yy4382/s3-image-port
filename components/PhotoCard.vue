<template>
  <div
    class="flex flex-col justify-between !bg-surface-50 dark:!bg-surface-800 p-2 gap-2 rounded-md h-full"
  >
    <div class="dark:text-white/80">
      ...
      <p>
        <span class="text-black/50 dark:text-white/50">Last Modified </span>
    ...
    <div class="flex justify-between items-center gap-2">
      <Chip class="pl-0 pr-3 h-fit" v-tooltip="`category`">
        <span
          class="bg-primary-500 dark:bg-primary-400 text-surface-0 dark:text-surface-900 rounded-full w-8 h-8 flex items-center justify-center"
          >C</span
        >
